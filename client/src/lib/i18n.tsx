...
const translations = {
  en: {
    ...
    premiumNote: "Subscription plans and pricing are subject to change. Payment processing will be available when the service launches.",
  ...
  zh: {
    ...
    premiumNote: "订阅计划和价格可能会有变动。服务上线后将提供支付处理。",
  ...
  ms: {
    ...
    premiumNote: "Pelan langganan dan harga tertakluk kepada perubahan. Pemprosesan pembayaran akan tersedia apabila perkhidmatan dilancarkan.",
